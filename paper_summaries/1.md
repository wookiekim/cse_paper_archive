...
![The_Order-Aware_Network_architecture](../assets/1/1_1.png =500x)
...
![Differentiable_Pooling_Layer](../assets/1/1_2.png =500x)
...
![Differentiable_UnPooling_Layer](../assets/1/1_3.png =500x)
...
![Order-Aware_Filtering_block](../assets/1/1_4.png =500x)
