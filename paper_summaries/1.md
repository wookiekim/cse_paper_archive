...
![The Order-Aware Network architecture](../assets/1/1_1.png =500x)
...
![Differentiable Pooling Layer](../assets/1/1_2.png =500x)
...
![Differentiable UnPooling Layer](../assets/1/1_3.png =500x)
...
![Order-Aware Filtering block](../assets/1/1_4.png =500x)
